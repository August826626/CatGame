            ...
            for (int col = 0; col < n-1; col++) {
                ...
                if (row != 0) { //not on top row
                    if (col != 0) { //if not on left side
                        ...
                        graph.addEdge(new CatEdge(v, v-n)); //top left
                    }
                    if (col != n) { //if not on right side
                        System.out.println(v + " -> " + (v-n+1));
                        graph.addEdge(new CatEdge(v, v-n+1)); //top right
                    }
                }
